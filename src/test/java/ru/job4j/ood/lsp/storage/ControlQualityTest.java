...
class ControlQualityTest {
    ...
    public void whenDistributeFoodThanItInCorrectStore() {
        Food product = new Food("Milk", LocalDate.now().minusDays(2), LocalDate.now().plusDays(8), 150);
        Store shop = new Shop();
    ...
    public void whenFoodInWarehouse() {
        Fruit apple = new Fruit("Apple", LocalDate.now().minusDays(3), LocalDate.now().plusDays(10), 150);
    ...
    public void whenMeatInShopWithPercentExpiryBetween25And75() {
        Meat beef = new Meat("Beef", LocalDate.now().minusDays(7), LocalDate.now().plusDays(8), 500);
    ...
    public void whenMeatInShopWithPercentExpiryBetween75And100AndMeatGetDiscount() {
        Meat beef = new Meat("Beef", LocalDate.now().minusDays(10), LocalDate.now().plusDays(3), 500);
        Shop shop = new Shop();
        assertTrue(shop.accept(beef));
    ...
    public void whenFoodInTrashAndPercentExpiryEquals100() {
        Food food = new Food("Not fresh", LocalDate.now().minusDays(10), LocalDate.now(), 0);
    ...
    public void whenFoodInTrashWithPercentExpiryMoreThan100() {
        Food food = new Food("Not fresh", LocalDate.now().minusDays(10), LocalDate.now().minusDays(2), 0);
        Trash trash = new Trash();
        assertTrue(trash.accept(food));
